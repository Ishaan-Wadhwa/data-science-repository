...
# base_pred = np.repeat(base_pred, len(y_test)) -> creates a new array base_pred by repeating the mean value base_pred for a number of times equal to the length of the y_test array. This effectively creates an array of the same length as y_test where all values are the mean of y_test.
...
# R squared value
# The R-squared score, often denoted as R2, is a statistical measure that represents the proportion of the variance in the dependent variable (y) that is explained by the independent variables (X) in a regression model. It typically ranges from 0 to 1, where a higher R2 value indicates a better fit of the model to the data.
r2_lin_test1=model_lin1.score(X_test,y_test)
r2_lin_train1=model_lin1.score(X_train,y_train)
print(r2_lin_test1,r2_lin_train1)

# Regression diagnostics- Residual plot analysis
# In a linear regression model, residuals represent the differences between the observed (actual) values of the dependent variable (y) and the predicted values of the dependent variable made by the model.
